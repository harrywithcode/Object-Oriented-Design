...
public class MainDriver {
	public static void main(String[] args){
		...
		GuitarSpec whatYouLike = new GuitarSpec(Builder.APERSON, "a", Type.HAND, 12, Wood.AWOOD, Wood.BWOOD);
	...
	private static void initializeInventory(Inventory inventory){
		inventory.addGuitar("ab", 0.2, Builder.APERSON, "a", Type.HAND, 12,
				Wood.AWOOD, Wood.BWOOD);
		
		inventory.addGuitar("a", 0, Builder.APERSON, "a", Type.HAND, 12, 
				Wood.AWOOD, Wood.BWOOD);
	}
}
